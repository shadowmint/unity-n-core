...
namespace N.Package.Core
{
  ...
  public static class MonoBehaviourExtensions
  {
    ...
    public static Option<Camera> Camera(this MonoBehaviour target)
    {
    ...
    public static void SetTexture(this MonoBehaviour target, Texture texture)
    {
      target.gameObject.SetTexture(texture);
    }
  }
}